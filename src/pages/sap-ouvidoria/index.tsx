    ...
    <section>
      ...
      <div className={styles.sapContent}>
        ...
        <div>
          ...
          <p>
            <strong>Funcionamento:</strong> segunda-feira a sexta-feira (exceto
            feriado)
          </p>
          <p>
      ...
      <div className={styles.ombudsmanContent}>
        ...
        <div>
          ...
          <p>
            <strong>Whatsapp:</strong> sap@transduartego.com.br
          </p>
        </div>
      ...
      <div className={styles.usefulInformation}>
        ...
        <article>
          ...
          <p>
            ...
            período, descartamos o material. Quanto aos bens não reclamados,
            esses serão doados ou descartados. Exigir do atendente que seja
            registrado seu pedido de verificação. Na retirada, assinar documento
            referente aos documentos ou objetos.{" "}
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            e-mail para contato@transduartego.com.br. No Assunto do e-mail,
            escrever: Acidente! No corpo do e-mail, se possível enviar placa,
            horário, fotos e local do ocorrido do acidente. Obrigatoriamente,
            conter no e-mail: nome, placa e modelo do veículo do outro envolvido
            no acidente. Evite enviar dados desnecessários para nossa apuração
            do caso.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            automaticamente. Use a sessão Empresa/Trabalhe Conosco. Os anúncios
            de recrutamento de pessoal serão publicados em nossas redes sociais:
            Facebook.com/grupotransduarte e Instragram/grupotransduarte.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            O material será descartado automaticamente. Use a sessão
