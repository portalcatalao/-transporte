  ...
  return (
    ...
    <section className={styles.tourismContainer}>
      ...
      <div className={styles.tourismContent}>
        <div>
          <span>Posuimos uma equipe de motoristas capacitados para melhor atender à seus clientes, oferecendo serviços de qualidade com preços competitivos, visando sempre garantir a sua satisfação.
</span>

          <article>
            <p>
            
A empresa possui cadastro na AGR, ANTT e Embratur, oferecendo um serviço totalmente regulamentado à seus clientes. Oferece locação de ônibus, microonibus, vans, taxi executivo, sempre com motorista, seguro de passageiros e combustível.
</p>
<p>
